      ...
      <div className="about-section-content">
        ...
        <div className="about-text">
          ...
          <p>
            ...
            adipisci sed officiis excepturi dolores tempora repudiandae fugiat
            natus assumenda? Dolores eos asperiores, tempore ipsum totam eveniet
            illum adipisci necessitatibus incidunt esse officia similique?
            Dolorum beatae soluta incidunt possimus a?
          </p>
        </div>
      </div>
    </section>
