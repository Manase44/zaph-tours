            ...
            <div className="package-gallery">
              {
                currentPackage.gallery.map((currentCard, i) => {
                  return(
                    <div key={i} className="package-gallery-card">
                    ...
                    <p className="card-description">Lorem ipsum dolor sit amet consectetur adipisicing elit. Illum veniam in voluptatibus animi, neque illo quibusdam consectetur, aut consequatur officia nobis, iusto architecto voluptas fugiat dignissimos pariatur. Dolor, nesciunt alias.</p>
